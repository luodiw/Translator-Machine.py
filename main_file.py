...
if __name__ == "__main__":
    ...
    try:
        ...
        e=input("\n\n=====================\nSome ,odules cannot be installed..\n=====================\nPress enter to exit.")
        quit()
    ...
    while '1' in ex:
        ...
        if '3' in user_choice:
            print("\nReading source.txt...")
            time.sleep(0.7)
            source_file=open('C:\\Users\\Mac\\Desktop\\PROJECTS\\Language_Translation_App\\source.txt','r')
            target_file=open('C:\\Users\\Mac\\Desktop\\PROJECTS\\Language_Translation_App\\target.txt','r+')
            source_text=source_file.read()
            target_text=translate(source_text)
            target_file.write(target_text)
            time.sleep(0.7)
            print('target.txt updated success!')
            bar()
